...
Self-serve voice channels for your server. Join New Public or New Private and I build a room just for you, then delete it once it empties. Own your room: rename it, set a limit, and drag people in from the Drag Me to Private waiting room. One /setup command, mod role included. Works across any number of servers, no privileged intents.
