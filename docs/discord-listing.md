...
Self-serve voice channels for your server. Join New Public or New Private and I build a room just for you, then delete it once it empties. Own your room: rename it, set a limit, and drag people in from the Drag Me to Private waiting room. Set a mod role for full control of every room. Works across any number of servers, no privileged intents.
...
Give a role full control of every room, private ones included, with /set-mod-role. It is perfect for staff who need to hop into any room to help out.
